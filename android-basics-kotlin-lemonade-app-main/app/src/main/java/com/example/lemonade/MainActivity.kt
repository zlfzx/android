...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        ...
        //  when the the image is clicked we may neecdd to change state to the next step in the
    ...
    private fun setViewElements() {
        ...
        if (lemonadeState == SELECT) {
            textAction.text = "Klik untuk memilih buah lemon!"
            lemonImage?.setImageResource(R.drawable.lemon_tree)
        }

        if (lemonadeState == SQUEEZE) {
            textAction.text = "Klik untuk memeras buah lemon!"
            lemonImage?.setImageResource(R.drawable.lemon_squeeze)
        }

        if (lemonadeState == DRINK) {
            textAction.text = "Klik untuk meminum limun Anda!"
            lemonImage?.setImageResource(R.drawable.lemon_drink)
        }

        if (lemonadeState == RESTART) {
            textAction.text = "Klik untuk memulai lagi!"
